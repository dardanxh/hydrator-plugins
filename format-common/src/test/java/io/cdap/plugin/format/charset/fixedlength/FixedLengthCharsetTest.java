...
import static io.cdap.plugin.format.plugin.AbstractFileSourceConfig.cleanFileEncodingName;
...
public class FixedLengthCharsetTest {
  ...
  public void testEncodingsAreValid() {
    ...
    for (String encoding : encodings) {
      Assert.assertTrue(FixedLengthCharset.isValidEncoding(cleanFileEncodingName(encoding)));
    }
